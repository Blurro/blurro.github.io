...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CGrwc9xg.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-Bh1K0VuP.js"),
...
var ROUTER_BASEPATH = "iwantmelunsmelons";
var SERVER_FN_BASE = "/iwantmelunsmelons/_serverFn/";
